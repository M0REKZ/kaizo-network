...
kz_image_ascendicon= Image("kz_ascendicon", "kz/ascendicon.png")
container.images.Add(kz_image_ascendicon)
set_kz_ascendicon = SpriteSet("kz_ascendicon", kz_image_ascendicon, 1, 1)
container.spritesets.Add(set_kz_ascendicon)
container.sprites.Add(Sprite("kz_ascendicon", set_kz_ascendicon, 0, 0, 1, 1))
