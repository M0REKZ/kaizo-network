...
public:
	enum
	{
		...
		//+KZ
		CUSTOM_ENTTYPE_KZPICKUP,
		CUSTOM_ENTTYPE_FDD_STABLE_PROJECTILE,
		CUSTOM_ENTTYPE_PORTAL_PROJECTILE,
		CUSTOM_ENTTYPE_PORTAL,
		CUSTOM_ENTTYPE_KZGUN,
		CUSTOM_ENTTYPE_KZPLASMA,
		CUSTOM_ENTTYPE_KZLIGHT,
		CUSTOM_ENTTYPE_MINE,
		CUSTOM_ENTTYPE_PORTAL_LASER,
