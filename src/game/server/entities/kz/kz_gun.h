...
#ifndef GAME_SERVER_ENTITIES_KZ_GUN_H
#define GAME_SERVER_ENTITIES_KZ_GUN_H
...
public:
	CKZGun(CGameWorld *pGameWorld, vec2 Pos, bool Damage, bool Explosive, int Layer = 0, int Number = 0);
