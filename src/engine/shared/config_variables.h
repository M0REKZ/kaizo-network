...
MACRO_CONFIG_INT(SvSaveGames, sv_savegames, 0, 0, 0, CFGFLAG_SERVER, "Enables savegames (/save and /load)") //+KZ disabled, it is broken due to Kaizo Network extra features
