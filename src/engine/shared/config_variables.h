...
MACRO_CONFIG_STR(SvRegister, sv_register, 1, "", CFGFLAG_SERVER, "Register server with master server for public listing, can also accept a comma-separated list of protocols to register on, like 'ipv4,ipv6'")
...
MACRO_CONFIG_INT(SvTestingCommands, sv_test_cmds, 1, 1, 1, CFGFLAG_SERVER, "Turns testing commands aka cheats on/off (setting only works in initial config)")
